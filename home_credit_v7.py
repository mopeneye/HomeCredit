...
def application_train_test(num_rows=None, nan_as_category=False):
    train = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\application_train.csv", nrows=num_rows)
    test = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\application_test.csv", nrows=num_rows)
...
def bureau_and_balance(num_rows=None, nan_as_category=True):
    bb = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\bureau_balance.csv", nrows=num_rows)
    ...
    bureau = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\bureau.csv", nrows=num_rows)
...
def Last_prev_prepare(num_rows=None):
    df = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\previous_application.csv", nrows=num_rows)
...
def previous_applications(num_rows=None):
    prev = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\previous_application.csv", nrows=num_rows)
...
def pos_cash(num_rows=None, nan_as_category=True):
    pos = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\POS_CASH_balance.csv", nrows=num_rows)
...
def installments_payments(num_rows=None, nan_as_category=True):
    ins = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\installments_payments.csv", nrows=num_rows)
...
def credit_card_balance(num_rows=None, nan_as_category=True):
    cc = pd.read_csv(r"E:\PROJECTS\HomeCredit\data\credit_card_balance.csv", nrows=num_rows)
